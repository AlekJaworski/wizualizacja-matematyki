...
const STRINGS = {
  ...
  results20minSub:   { pl: "Konkretny plan. Bez paraliżu „62 tematów\". Po 20 minutach wracasz tutaj.",
                       en: "A concrete plan. No 62-topic paralysis. Come back here after 20 min." },
  ...
  results20minCta:   { pl: "Zaczynam →",                       en: "Let's go →" },
  resultsStartPath:  { pl: "Zacznij naukę — ścieżka do pierwszej luki",
                       en: "Start learning — path to your first gap" },
