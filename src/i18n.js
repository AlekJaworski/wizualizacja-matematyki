...
const STRINGS = {
  ...
  resultsWhyHere:    { pl: "Pytania o ten temat sugerują, że warto tu się zatrzymać — klasa przerabiała to szybko, tutaj możesz spokojnie.",
                       en: "Your answers suggest it's worth pausing here — class moved through this quickly, here you can take your time." },
  ...
  resultsStartPath:  { pl: "Zacznij naukę — ścieżka od pierwszego miejsca startu",
                       en: "Start learning — path from your first starting point" },
